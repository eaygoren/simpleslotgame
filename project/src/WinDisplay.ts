...
export class WinDisplay extends PIXI.Container {
    ...
    private create() {
        ...
        this._highlight.alpha = 0.5; // Makes the sprite semi-transparent
        this._highlight.visible = false; // Initially, the highlight is not visible
        this._highlight.tint = 0x5777c1; // Set tint to the highlight
        ...
        this._winAmount.text = "0"; // Default text value
